...
(function() {
  function initNavbar() {
    ...
    // Style prev/next buttons with inline styles to override all CSS
    setTimeout(function() {
      const prevButton = document.querySelector('a[rel="prev"]');
      const nextButton = document.querySelector('a[rel="next"]');
      
      const buttonStyles = 'color: #ffffff !important; background-color: #1a1a1a !important; border: 3px solid #00ff00 !important; padding: 14px 22px !important; border-radius: 8px !important; font-weight: 700 !important; font-size: 1.1rem !important; font-family: "Courier New", Courier, monospace !important; display: inline-flex !important; align-items: center !important; gap: 10px !important; text-decoration: none !important; box-shadow: 0 0 20px rgba(0, 255, 0, 0.7) !important; text-shadow: 0 0 10px rgba(0, 255, 0, 0.5) !important;';
      
      const hoverStyles = 'color: #000000 !important; background-color: #00ff00 !important; border: 3px solid #00ff00 !important; padding: 14px 22px !important; border-radius: 8px !important; font-weight: 700 !important; font-size: 1.1rem !important; font-family: "Courier New", Courier, monospace !important; display: inline-flex !important; align-items: center !important; gap: 10px !important; text-decoration: none !important; box-shadow: 0 0 30px rgba(0, 255, 0, 1), 0 0 60px rgba(0, 255, 0, 0.8) !important;';
      
      if (prevButton) {
        prevButton.setAttribute('style', buttonStyles);
        prevButton.addEventListener('mouseenter', function() {
          this.setAttribute('style', hoverStyles);
        });
        prevButton.addEventListener('mouseleave', function() {
          this.setAttribute('style', buttonStyles);
        });
      }
      
      if (nextButton) {
        nextButton.setAttribute('style', buttonStyles);
